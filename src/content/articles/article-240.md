...
partSlug: part-viii
summary: Article 240 covers power of President to make regulations for certain Union territories.
plainEnglish: This page reproduces the official text of Article 240. The constitutional wording is the primary reference point, and interpretive layers are added through linked cases, amendments, topics, and current-affairs pages.
officialText: |-
  ...
  (a) the Andaman and Nicobar Islands; [(b) Lakshadweep;] [(c) Dadra and Nagar Haveli and Daman and Diu;] [(d) **** ;] [(e) [Puducherry ];]
