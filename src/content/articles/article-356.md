...
partSlug: part-xviii
summary: Article 356 allows President's Rule when the constitutional machinery of a state is said to have failed.
plainEnglish: This is one of the most controversial emergency powers in the Constitution. It lets the Union intervene in a state, but courts have imposed limits because of the risk of partisan misuse.
officialText: |-
  ...
  [Provided also that in the case of the Proclamation issued under clause (1) on the 11th day of May, 1987 with respect to the State of Punjab, the reference in the first proviso to this clause to “three years” shall be construed as a reference to [five years].] [(5) Notwithstanding anything contained in clause (4), a resolution with respect to the continuance in force of a Proclamation approved under clause (3) for any period beyond the expiration of one year from the date of issue of such Proclamation shall not be passed by either House of Parliament unless—
...
Article 356 lies at the fault line between Union power and state autonomy. Its history shows why constitutional text alone is not enough without judicial limits and political restraint.

## Reading the provision

The formal trigger is a failure of constitutional machinery in a state. In practice, that phrase can be stretched, which is why later case law became crucial to protect federalism.

## How courts use it

The Supreme Court's scrutiny of Article 356 proclamations focuses on material, mala fides, and whether legislative majority should instead be tested on the floor of the assembly.
