...
constitution_refs: []
related_parts:
  - '[[../parts/part-xi|Part XI - Relations Between the Union and the States]]'
related_schedules: []
related_cases: []
related_topics: []
related_issues: []
...
Article 252 covers power of Parliament to legislate for two or more States by consent and adoption of such legislation by any other State.
...
This page reproduces the official text of Article 252. The constitutional wording is the primary reference point, and interpretive layers are added through linked cases, amendments, topics, and current-affairs pages.
