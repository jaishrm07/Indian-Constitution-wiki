...
constitution_refs: []
related_parts:
  - '[[../parts/part-iva|Part IVA - Fundamental Duties]]'
related_schedules: []
related_cases: []
related_topics: []
related_issues: []
...
Article 51A covers fundamental duties.
...
This page reproduces the official text of Article 51A. The constitutional wording is the primary reference point, and interpretive layers are added through linked cases, amendments, topics, and current-affairs pages.
