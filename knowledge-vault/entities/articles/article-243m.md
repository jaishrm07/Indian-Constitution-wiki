...
constitution_refs: []
related_parts:
  - '[[../parts/part-ix|Part IX - The Panchayats]]'
related_schedules: []
related_cases: []
related_topics: []
related_issues: []
...
Article 243M covers part not to apply to certain areas.
...
This page reproduces the official text of Article 243M. The constitutional wording is the primary reference point, and interpretive layers are added through linked cases, amendments, topics, and current-affairs pages.
